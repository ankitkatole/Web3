...
const SignUp = ({ onSwitchToSignIn }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Sign Up Data:', { username, email, name, password });
    console.log('Sign Up attempted! Check console for data.');
  };
  ...
  return (
    <div className="bg-gray-800 bg-opacity-70 backdrop-filter backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-500 hover:scale-[1.02] hover:shadow-purple-500/30 border border-gray-700 relative overflow-hidden group">
      ...
      <h2 className="text-4xl font-extrabold mb-8 text-center text-purple-400 tracking-wide">Join Us!</h2>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="signup-username" className="block text-sm font-medium text-gray-300 mb-2 transform translate-x-1 transition duration-300 ease-out">
            Username
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="signup-email" className="block text-sm font-medium text-gray-300 mb-2 transform translate-x-1 transition duration-300 ease-out">
            Email
          </label>
          <input
            type="email"
        ...
        <div>
          <label htmlFor="signup-name" className="block text-sm font-medium text-gray-300 mb-2 transform translate-x-1 transition duration-300 ease-out">
            Full Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="signup-password" className="block text-sm font-medium text-gray-300 mb-2 transform translate-x-1 transition duration-300 ease-out">
            Password
          </label>
          <input
            type="password"
